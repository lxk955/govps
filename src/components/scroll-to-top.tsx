...
import { FLOAT_ABOVE_TABBAR, FLOAT_ABOVE_TABBAR_AND_BAR } from "@/lib/nav";
  ...
  return (
    <button
      ...
      className={cn(
        ...
        hasCompareBar
          ? `${FLOAT_ABOVE_TABBAR_AND_BAR} right-4 sm:bottom-20 sm:right-6`
          : `${FLOAT_ABOVE_TABBAR} right-4 sm:bottom-6 sm:right-6`,
        visible
